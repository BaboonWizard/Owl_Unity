...
public class SpeechBubble : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		GUI.Label(new Rect(0,0,200,100),"",bubbleSkin.customStyles[0]);
		
		//Render the text
		GUI.Label(new Rect(10,25,190,50),"You can add any GUI element here, like the button below:",bubbleSkin.label);
